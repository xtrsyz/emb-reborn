...
// rename to default.php
// Default config.
// Will be overwritten by domain config or add-ons if exists.
// If off/commented = using default value from internal engine class.
...
// $config->meta_robots_home     = 'noindex,follow';
